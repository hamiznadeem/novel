...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2026 at 12:55 AM
...
(1, 'admin', '$2y$10$jyjcyzKS.vK8EFOwfzo0AOGg7JYEAZVptLMgdiwGQFoRPHHOWhMVS');
...
CREATE TABLE `novels` (
  ...
  `category` enum('islamic','fictional','premuim','') NOT NULL,
